...
c1, c2 = st.columns(2)
start_date = c1.date_input("Backtest Timeline Start", value=pd.to_datetime("2025-08-01"))
end_date = c2.date_input("Backtest Timeline Close", value=pd.to_datetime("2025-08-31"))
